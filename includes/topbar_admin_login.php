        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/TD/pdo-crud-bootstrap5-main/index.php">ระบบจัดการ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/TD/view_order_admin.php">จัดการออเดอร์</a>
                    </li>
                    <li class="nav-item">
